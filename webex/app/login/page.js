...
function Login() {
	...
	<div className="flex items-center pt-4 space-x-1">
		...
		<p className="px-3 text-sm dark:text-gray-600">Ingresar con otros métodos</p>
		<div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
	</div>
	<div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" className="p-3 rounded-sm">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-[#09f]">
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-600">No tenes cuenta?
		<a rel="noopener noreferrer" href="#" className="underline text-[#09f] pl-2">Registrate</a>
	</p>
</div>
</div>
    );
